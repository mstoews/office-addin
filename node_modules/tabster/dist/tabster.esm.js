...
function getUncontrolledFocusTrapContainer(tabster, element) {
  var _a;
  ...
  do {
    if (((_a = getTabsterOnElement(tabster, el)) === null || _a === void 0 ? void 0 : _a.uncontrolled) && tabster.uncontrolled.isTrappingFocus(el)) {
      return el;
    }
...
class FocusedElementState extends Subscribable {
  constructor(tabster, getWindow) {
    ...
    this._onKeyDown = e => {
      ...
      const uncontrolledFocusTrapContainer = getUncontrolledFocusTrapContainer(tabster, currentElement);
      ...
      if (nextElement) {
        ...
        if (ctx.uncontrolled || (nextUncontrolled === null || nextUncontrolled === void 0 ? void 0 : nextUncontrolled.contains(currentElement))) {
          if (!next.outOfDOMOrder && nextUncontrolled === ctx.uncontrolled || uncontrolledFocusTrapContainer && !uncontrolledFocusTrapContainer.contains(nextElement)) {
...
class UncontrolledAPI {
  constructor(isTrappingFocus) {
    this._isTrappingFocus = isTrappingFocus;
  }

  isTrappingFocus(element) {
    var _a;

    return !!((_a = this._isTrappingFocus) === null || _a === void 0 ? void 0 : _a.call(this, element));
  }
...
class TabsterCore {
  constructor(win, props) {
    ...
    this.uncontrolled = new UncontrolledAPI(props === null || props === void 0 ? void 0 : props.checkUncontrolledTrappingFocus);
